    ...
    Explore.prototype.componentDidMount = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_e) {
                ...
                if (!initialized) {
                    _b = (urlState || {}), datasource = _b.datasource, queries = _b.queries, _c = _b.range, range = _c === void 0 ? app_core_utils_explore__WEBPACK_IMPORTED_MODULE_14__["DEFAULT_RANGE"] : _c, _d = _b.ui, ui = _d === void 0 ? app_core_utils_explore__WEBPACK_IMPORTED_MODULE_14__["DEFAULT_UI_STATE"] : _d;
                    initialDatasource = datasource || app_core_store__WEBPACK_IMPORTED_MODULE_5__["default"].get(app_core_utils_explore__WEBPACK_IMPORTED_MODULE_14__["LAST_USED_DATASOURCE_KEY"]);
                    initialQueries = Object(app_core_utils_explore__WEBPACK_IMPORTED_MODULE_14__["ensureQueries"])(queries);
                    initialRange = { from: Object(_TimePicker__WEBPACK_IMPORTED_MODULE_12__["parseTime"])(range.from), to: Object(_TimePicker__WEBPACK_IMPORTED_MODULE_12__["parseTime"])(range.to) };
    ...
    Explore.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: exploreClass, ref: this.getRef },
            ...
            datasourceError && (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "explore-container" },
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_Error__WEBPACK_IMPORTED_MODULE_6__["Alert"], { message: "Error connecting to datasource: " + datasourceError }))),
            datasourceInstance && !datasourceError && (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "explore-container" },
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "explore-toolbar-item" },
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "explore-toolbar-header" },
                    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "explore-toolbar-header-title" }, exploreId === 'left' && (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("span", { className: "navbar-page-btn" },
                        ...
                        "Explore"))),
                    exploreId === 'right' && (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("a", { className: "explore-toolbar-header-close", onClick: this.props.closeSplit },
...
var LogLabels = /** @class */ (function (_super) {
    ...
    LogLabels.prototype.render = function () {
        ...
        return Object.keys(labels).map(function (key) { return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_LogLabel__WEBPACK_IMPORTED_MODULE_2__["LogLabel"], { key: key, getRows: getRows, label: key, value: labels[key], plain: plain, onClickLabel: onClickLabel })); });
    };
    return LogLabels;
}(react__WEBPACK_IMPORTED_MODULE_1__["PureComponent"]));
...
var LogRow = /** @class */ (function (_super) {
    ...
    LogRow.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "logs-row" },
            ...
            showLocalTime && (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "logs-row__time", title: row.timestamp + " (" + row.timeFromNow + ")" }, row.timeLocal)),
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "logs-row__message", onMouseEnter: this.onMouseOverMessage, onMouseLeave: this.onMouseOutMessage },
                parsed && (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_highlight_words__WEBPACK_IMPORTED_MODULE_3___default.a, { autoEscape: true, highlightTag: FieldHighlight(this.onClickHighlight), textToHighlight: row.entry, searchWords: parsedFieldHighlights, highlightClassName: "logs-row__field-highlight" })),
...
/* harmony import */ var app_core_time_series2__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! app/core/time_series2 */ "./public/app/core/time_series2.ts");
...
/* harmony import */ var app_core_components_ToggleButtonGroup_ToggleButtonGroup__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! app/core/components/ToggleButtonGroup/ToggleButtonGroup */ "./public/app/core/components/ToggleButtonGroup/ToggleButtonGroup.tsx");
/* harmony import */ var _Graph__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Graph */ "./public/app/features/explore/Graph.tsx");
/* harmony import */ var _LogLabels__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./LogLabels */ "./public/app/features/explore/LogLabels.tsx");
/* harmony import */ var _LogRow__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./LogRow */ "./public/app/features/explore/LogRow.tsx");
...
function renderMetaItem(value, kind) {
    if (kind === app_core_logs_model__WEBPACK_IMPORTED_MODULE_6__["LogsMetaKind"].LabelsMap) {
        return (react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("span", { className: "logs-meta-item__labels" },
            react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_LogLabels__WEBPACK_IMPORTED_MODULE_9__["LogLabels"], { labels: value, plain: true })));
    }
    return value;
}
var Logs = /** @class */ (function (_super) {
    ...
    function Logs() {
        ...
        _this.onChangeDedup = function (dedup) {
            ...
            if (_this.props.dedupStrategy === dedup) {
                return onDedupStrategyChange(app_core_logs_model__WEBPACK_IMPORTED_MODULE_6__["LogsDedupStrategy"].none);
            }
    ...
    Logs.prototype.render = function () {
        ...
        var _c = this.state, deferLogs = _c.deferLogs, renderAll = _c.renderAll, showLocalTime = _c.showLocalTime, showUtc = _c.showUtc;
        ...
        var showDuplicates = dedupStrategy !== app_core_logs_model__WEBPACK_IMPORTED_MODULE_6__["LogsDedupStrategy"].none;
        var dedupCount = dedupedData.rows.reduce(function (sum, row) { return sum + row.duplicates; }, 0);
        var meta = data.meta.slice();
        if (dedupStrategy !== app_core_logs_model__WEBPACK_IMPORTED_MODULE_6__["LogsDedupStrategy"].none) {
            meta.push({
                label: 'Dedup count',
                value: dedupCount,
        ...
        var scanText = scanRange ? "Scanning " + app_core_utils_rangeutil__WEBPACK_IMPORTED_MODULE_3__["describeTimeRange"](scanRange) : 'Scanning...';
        // React profiler becomes unusable if we pass all rows to all rows and their labels, using getter instead
        var getRows = function () { return processedRows; };
        var timeSeries = data.series.map(function (series) { return new app_core_time_series2__WEBPACK_IMPORTED_MODULE_5__["default"](series); });
        return (react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", { className: "logs-panel" },
            react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", { className: "logs-panel-graph" },
                react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_Graph__WEBPACK_IMPORTED_MODULE_8__["default"], { data: timeSeries, height: 100, width: width, range: range, id: "explore-logs-graph-" + exploreId, onChangeTime: this.props.onChangeTime, onToggleSeries: this.onToggleLogLevel, userOptions: graphOptions })),
            react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", { className: "logs-panel-options" },
                react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", { className: "logs-panel-controls" },
                    react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Switch"], { label: "Timestamp", checked: showUtc, onChange: this.onChangeUtc, transparent: true }),
                    react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Switch"], { label: "Local time", checked: showLocalTime, onChange: this.onChangeLocalTime, transparent: true }),
                    react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_4__["Switch"], { label: "Labels", checked: showLabels, onChange: this.onChangeLabels, transparent: true }),
                    react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(app_core_components_ToggleButtonGroup_ToggleButtonGroup__WEBPACK_IMPORTED_MODULE_7__["default"], { label: "Dedup", transparent: true }, Object.keys(app_core_logs_model__WEBPACK_IMPORTED_MODULE_6__["LogsDedupStrategy"]).map(function (dedupType, i) { return (react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(app_core_components_ToggleButtonGroup_ToggleButtonGroup__WEBPACK_IMPORTED_MODULE_7__["ToggleButton"], { key: i, value: dedupType, onChange: _this.onChangeDedup, selected: dedupStrategy === dedupType, tooltip: app_core_logs_model__WEBPACK_IMPORTED_MODULE_6__["LogsDedupDescription"][dedupType] }, dedupType)); })))),
            hasData && meta && (react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", { className: "logs-panel-meta" }, meta.map(function (item) { return (react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", { className: "logs-panel-meta__item", key: item.label },
...
var mapDispatchToProps = {
    ...
    highlightLogsExpressionAction: _state_actionTypes__WEBPACK_IMPORTED_MODULE_8__["highlightLogsExpressionAction"],
    modifyQueries: _state_actions__WEBPACK_IMPORTED_MODULE_7__["modifyQueries"],
    removeQueryRowAction: _state_actionTypes__WEBPACK_IMPORTED_MODULE_8__["removeQueryRowAction"],
...
/* harmony import */ var _ErrorBoundary__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ErrorBoundary */ "./public/app/features/explore/ErrorBoundary.tsx");
/* harmony import */ var _Explore__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./Explore */ "./public/app/features/explore/Explore.tsx");
...
var Wrapper = /** @class */ (function (_super) {
    ...
    function Wrapper(props) {
        ...
        if (props.urlStates.left) {
            _this.urlStates.leftState = Object(app_core_utils_explore__WEBPACK_IMPORTED_MODULE_6__["parseUrlState"])(left);
        }
        if (props.urlStates.right) {
            _this.urlStates.rightState = Object(app_core_utils_explore__WEBPACK_IMPORTED_MODULE_6__["parseUrlState"])(right);
    ...
    Wrapper.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "page-scrollbar-wrapper" },
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_9__["CustomScrollbar"], { autoHeightMin: '100%' },
                react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", { className: "explore-wrapper" },
                    react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_ErrorBoundary__WEBPACK_IMPORTED_MODULE_7__["default"], null,
                        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_Explore__WEBPACK_IMPORTED_MODULE_8__["default"], { exploreId: app_types_explore__WEBPACK_IMPORTED_MODULE_5__["ExploreId"].left, urlState: leftState })),
                    split && (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_ErrorBoundary__WEBPACK_IMPORTED_MODULE_7__["default"], null,
                        react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_Explore__WEBPACK_IMPORTED_MODULE_8__["default"], { exploreId: app_types_explore__WEBPACK_IMPORTED_MODULE_5__["ExploreId"].right, urlState: rightState })))))));
    };
    return Wrapper;
}(react__WEBPACK_IMPORTED_MODULE_1__["Component"]));
...
var mapDispatchToProps = {
    initializeExploreSplitAction: _state_actionTypes__WEBPACK_IMPORTED_MODULE_10__["initializeExploreSplitAction"],
    updateLocation: app_core_actions__WEBPACK_IMPORTED_MODULE_4__["updateLocation"],
    resetExploreAction: _state_actionTypes__WEBPACK_IMPORTED_MODULE_10__["resetExploreAction"],
};
...
/*!******************************************************!*\
  !*** ./public/app/features/explore/state/actions.ts ***!
  \******************************************************/
/*! exports provided: addQueryRow, changeDatasource, changeQuery, changeSize, changeTime, clearQueries, initializeExplore, loadDatasourceSuccess, importQueries, loadDatasource, modifyQueries, queryTransactionFailure, queryTransactionSuccess, runQueries, scanStart, setQueries, splitClose, splitOpen, stateSave, toggleGraph, toggleLogs, toggleTable, changeDedupStrategy */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "loadDatasourceSuccess", function() { return loadDatasourceSuccess; });
...
/* harmony import */ var _actionTypes__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./actionTypes */ "./public/app/features/explore/state/actionTypes.ts");
...
var updateExploreUIState = function (exploreId, uiStateFragment) {
    return function (dispatch) {
        dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["updateUIStateAction"])(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ exploreId: exploreId }, uiStateFragment)));
        dispatch(stateSave());
    };
};
/**
...
function changeDatasource(exploreId, datasource) {
    ...
    return function (dispatch, getState) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Object(app_features_plugins_datasource_srv__WEBPACK_IMPORTED_MODULE_3__["getDatasourceSrv"])().get(datasource)];
                case 1:
                ...
                case 2:
                    _a.sent();
                    dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["updateDatasourceInstanceAction"])({ exploreId: exploreId, datasourceInstance: newDataSourceInstance }));
                    _a.label = 3;
                case 3:
                    _a.trys.push([3, 5, , 6]);
...
function changeQuery(exploreId, query, index, override) {
    return function (dispatch) {
        ...
        if (query === null) {
            query = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, Object(app_core_utils_explore__WEBPACK_IMPORTED_MODULE_4__["generateEmptyQuery"])(index));
        }
        dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["changeQueryAction"])({ exploreId: exploreId, query: query, index: index, override: override }));
        if (override) {
            dispatch(runQueries(exploreId));
        }
    };
...
function changeSize(exploreId, _a) {
    ...
    return Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["changeSizeAction"])({ exploreId: exploreId, height: height, width: width });
}
/**
...
function changeTime(exploreId, range) {
    return function (dispatch) {
        dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["changeTimeAction"])({ exploreId: exploreId, range: range }));
        dispatch(runQueries(exploreId));
    };
}
/**
...
function clearQueries(exploreId) {
    return function (dispatch) {
        dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["scanStopAction"])({ exploreId: exploreId }));
        dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["clearQueriesAction"])({ exploreId: exploreId }));
        dispatch(stateSave());
    };
}
/**
...
function initializeExplore(exploreId, datasourceName, queries, range, containerWidth, eventBridge, ui) {
    ...
    return function (dispatch) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
            switch (_a.label) {
                case 0:
                    exploreDatasources = Object(app_features_plugins_datasource_srv__WEBPACK_IMPORTED_MODULE_3__["getDatasourceSrv"])()
                        .getExternal()
                    ...
                    dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["initializeExploreAction"])({
                        exploreId: exploreId,
                ...
                case 5:
                    ...
                    _a.label = 6;
                case 6:
                    dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["updateDatasourceInstanceAction"])({ exploreId: exploreId, datasourceInstance: instance }));
                    _a.label = 7;
                case 7:
                    _a.trys.push([7, 9, , 10]);
                ...
                case 10:
                    ...
                    return [3 /*break*/, 12];
                case 11:
                    dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["loadDatasourceMissingAction"])({ exploreId: exploreId }));
                    _a.label = 12;
 ...
 */
var loadDatasourceSuccess = function (exploreId, instance) {
    // Capabilities
    ...
    return Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["loadDatasourceSuccessAction"])({
        exploreId: exploreId,
        StartPage: StartPage,
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    _a.label = 4;
                case 4:
                    nextQueries = importedQueries.map(function (q, i) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, q, Object(app_core_utils_explore__WEBPACK_IMPORTED_MODULE_4__["generateEmptyQuery"])(i))); });
                    dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["queriesImportedAction"])({ exploreId: exploreId, queries: nextQueries }));
                    return [2 /*return*/];
            }
        });
    }); };
        ...
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["loadDatasourcePendingAction"])({ exploreId: exploreId, requestedDatasourceName: datasourceName }));
                ...
                case 4:
                    if (datasourceError) {
                        dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["loadDatasourceFailureAction"])({ exploreId: exploreId, error: datasourceError }));
...
function queryTransactionFailure(exploreId, transactionId, response, datasourceId) {
    return function (dispatch, getState) {
        ...
        dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["queryTransactionFailureAction"])({ exploreId: exploreId, queryTransactions: nextQueryTransactions }));
    };
}
/**
...
function queryTransactionSuccess(exploreId, transactionId, result, latency, queries, datasourceId) {
    return function (dispatch, getState) {
        ...
        dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["queryTransactionSuccessAction"])({
            exploreId: exploreId,
            history: nextHistory,
        ...
        if (scanning) {
            if (lodash__WEBPACK_IMPORTED_MODULE_1___default.a.size(result) === 0) {
                ...
                if (!other) {
                    var range = scanner();
                    dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["scanRangeAction"])({ exploreId: exploreId, range: range }));
                }
            }
            else {
...
function runQueries(exploreId, ignoreUIState) {
    ...
    return function (dispatch, getState) {
        ...
        if (!Object(app_core_utils_explore__WEBPACK_IMPORTED_MODULE_4__["hasNonEmptyQuery"])(queries)) {
            dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["runQueriesEmptyAction"])({ exploreId: exploreId }));
                ...
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["queryTransactionStartAction"])({ exploreId: exploreId, resultType: resultType, rowIndex: rowIndex, transaction: transaction }));
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            now = Date.now();
...
function scanStart(exploreId, scanner) {
    return function (dispatch) {
        ...
        dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["scanStartAction"])({ exploreId: exploreId, scanner: scanner }));
...
function setQueries(exploreId, rawQueries) {
    return function (dispatch) {
        ...
        var queries = rawQueries.map(function (q) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, q, Object(app_core_utils_explore__WEBPACK_IMPORTED_MODULE_4__["generateEmptyQuery"])())); });
        dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["setQueriesAction"])({ exploreId: exploreId, queries: queries }));
        dispatch(runQueries(exploreId));
    };
}
/**
...
function splitClose() {
    return function (dispatch) {
        dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["splitCloseAction"])());
        dispatch(stateSave());
    };
}
/**
...
function splitOpen() {
    return function (dispatch, getState) {
        ...
        var itemState = tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, leftState, { queryTransactions: [], queries: leftState.queries.slice() });
        dispatch(Object(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["splitOpenAction"])({ itemState: itemState }));
        dispatch(stateSave());
    };
}
/**
...
var togglePanelActionCreator = function (actionCreator) { return function (exploreId, isPanelVisible) {
    return function (dispatch) {
        ...
        switch (actionCreator.type) {
            case _actionTypes__WEBPACK_IMPORTED_MODULE_6__["toggleGraphAction"].type:
                uiFragmentStateUpdate = { showingGraph: !isPanelVisible };
                break;
            case _actionTypes__WEBPACK_IMPORTED_MODULE_6__["toggleLogsAction"].type:
                uiFragmentStateUpdate = { showingLogs: !isPanelVisible };
                break;
            case _actionTypes__WEBPACK_IMPORTED_MODULE_6__["toggleTableAction"].type:
 ...
 */
var toggleGraph = togglePanelActionCreator(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["toggleGraphAction"]);
/**
 * Expand/collapse the logs result viewer. When collapsed, log queries won't be run.
 */
var toggleLogs = togglePanelActionCreator(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["toggleLogsAction"]);
/**
 * Expand/collapse the table result viewer. When collapsed, table queries won't be run.
 */
var toggleTable = togglePanelActionCreator(_actionTypes__WEBPACK_IMPORTED_MODULE_6__["toggleTableAction"]);
/**
...
//# sourceMappingURL=explore.eace4a51787eca54e0d8.js.map